...
def carregar_produtos():
    ...
    if not os.path.exists("inventario.csv"):
        ...
        produtos[101] = ["Saint's Row IV", 15, 7.99, True]
        produtos[102] = ["Resident Evil Requiem", 40, 69.99, False]
        produtos[103] = ["Persona 3 Reload", 25, 239.99, True]
        produtos[104] = ["God of War Ragnarok", 10, 349.99, True]
        produtos[105] = ["Fifa 26", 1, 399.99, True]
        produtos[106] = ["Cuphead", 5, 120.00, False]
